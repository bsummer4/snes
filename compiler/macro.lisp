(defconstant +addressing-modes-and-syntax+
    '((:implied "")
      (:accumulator "A")
      (:immediate "#")
      (:direct "b")
      ...
      (:stack-relative-inderect-y-indexed "(b,S),Y")
      (:block-mode "b,b")
      (:absolute "w")
...
"
Everything after this is untested.  It is just to get a good idea of
how best to layout this code.
"

(defun asm-subformat (format-char argument)
  (format nil (ecase format-char (#\b "$~2x") (#\w "$~s") (#\l "$~4x"))
              argument))
